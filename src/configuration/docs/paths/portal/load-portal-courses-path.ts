export const loadPortalCoursesPath = {
  ...
  description:
    'Carrega uma lista dos cursos oferecidos (como valores de cabeçalho, ou seja, sem conteúdo). Aceita parâmetros de paginação que são opcionais. Essa rota pode ser executada por **qualquer usuário**.',
  parameters: [
    {
      name: 'page',
      in: 'query',
